    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: '#F6DBA6', fontSize: 12, marginBottom: 8, fontWeight: 600 }}>
            ✓ OPTIMAL
          </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
          <div style={{ textAlign: 'center', padding: 16, background: '#121212', borderRadius: 8 }}>
          ...
          <div style={{ textAlign: 'center', padding: 16, background: 'rgba(201, 169, 98, 0.1)', borderRadius: 8 }}>
            <div style={{ color: '#F6DBA6', fontSize: 12, marginBottom: 8 }}>At Optimal Rate</div>
            <div style={{ color: '#F6DBA6', fontSize: 24, fontWeight: 700 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 12 }}>
          <div style={{ padding: 12, background: '#121212', borderRadius: 8 }}>
