...
export function LandingPage({ onShowLogin }: LandingPageProps) {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // Redirect to Stripe checkout - payment first, then account creation
      ...
      let errorMsg = error.message || 'Checkout failed. Please try again.';
          ...
          {signupSuccess ? (
            ...
            <>
              ...
              <form onSubmit={handleSignup}>
                ...
                >
                  {signupLoading ? 'Redirecting to checkout...' : 'Become a Founding Member — $279'}
                </button>
              </form>
