...
const contentHtml = `<p>Today's market was a masterclass in what happens when Wall Street expectations meet reality. Software got crushed, gold went parabolic, and Congress is about to shut down the government. Again.</p>

<div class="tldr">
<h3>TL;DR</h3>
<ul>
<li><strong>Microsoft down 10%</strong> despite beating earnings. Cloud growth slowing = death sentence in this market.</li>
<li><strong>Gold hit $5,600</strong> before pulling back. Central banks are buying, dollar at 4-year low.</li>
<li><strong>79% chance of government shutdown</strong> Saturday. Senate blocked the funding bill.</li>
<li><strong>Fed held rates at 3%-3.75%</strong>. Trump naming new Fed chair next week.</li>
<li><strong>Bottom line:</strong> Market is getting surgical. Prove your AI story or get crushed.</li>
</ul>
</div>
...
async function main() {
  ...
  else console.log('Updated:', data?.[0]?.slug);
}
